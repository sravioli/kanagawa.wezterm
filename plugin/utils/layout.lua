...
---
---@return Utils.Layout layout newly created class instance.
function M:new()
...
---@return Utils.Layout self The updated layout instance.
...
---
---@return Utils.Layout self The cleared layout instance.
function M:clear()
  self.layout = {}
  return self
end
